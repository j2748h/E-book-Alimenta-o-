...
export const Story: React.FC = () => {
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-white via-[#fcfdfe] to-[#eff7f3] overflow-hidden" id="proposito">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 sm:gap-16 items-center">
          ...
          <div className="lg:col-span-5 relative flex items-center justify-center">
            ...
            <div className="relative w-full max-w-[340px] md:max-w-[400px]">
              ...
              <div className="absolute inset-x-8 -inset-y-4 rounded-[2.5rem] border-2 border-dashed border-brand-accent/40 transform -rotate-3 pointer-events-none"></div>
 
              {/* Happy cooking family photo */}
              <div className="relative bg-white p-4 rounded-[2.5rem] shadow-[0_24px_50px_rgba(0,0,0,0.12)] border border-gray-100 transform rotate-1 hover:rotate-0 transition-transform duration-300">
                <img
                  ...
                  className="w-full aspect-[4/3] object-cover rounded-[1.8rem]"
                  id="story-family-image"
                />
                
                {/* Micro-badge overlay on photo */}
                <div className="absolute bottom-6 right-6 bg-brand-primary text-white text-[10px] sm:text-xs font-black px-4 py-1.5 rounded-full uppercase tracking-widest shadow-md opacity-95 select-none inline-flex items-center gap-1">
                  <Sparkles className="w-3 h-3 text-brand-accent fill-brand-accent animate-spin" />
                  <span>Propósito Familiar</span>
                </div>
              </div>
 
              {/* Tiny floating overlap statistics */}
              <div className="absolute -bottom-6 -left-6 bg-[#061e14] text-white rounded-[1.8rem] p-5 shadow-2xl border border-brand-primary/25 max-w-[210px] text-left select-none">
                <div className="flex items-center gap-1.5 text-brand-accent mb-2">
                  ...
                  <span className="text-xs font-black font-display uppercase tracking-wider">Independente</span>
                </div>
                <p className="text-[10px] sm:text-xs text-emerald-100/80 leading-relaxed font-sans font-medium">
          ...
          <div className="lg:col-span-7 space-y-6 md:space-y-8 text-center lg:text-left">
            ...
            <div className="space-y-4">
              ...
              <h3 className="font-display font-bold text-lg sm:text-xl text-brand-primary">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-left border-t border-gray-150 pt-6">
              <div className="flex items-start gap-3 bg-white p-4 rounded-2xl border border-gray-100 shadow-2xs hover:shadow-xs transition-shadow">
                ...
                <div>
                  ...
                  <p className="text-[10px] sm:text-xs text-gray-400 mt-1.5 font-medium leading-relaxed">Conectamos pessoas com o mesmo objetivo de saúde.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 bg-white p-4 rounded-2xl border border-gray-100 shadow-2xs hover:shadow-xs transition-shadow">
                ...
                <div>
                  <h4 className="text-xs sm:text-sm font-black text-brand-dark leading-none">Independência Editorial</h4>
                  <p className="text-[10px] sm:text-xs text-gray-400 mt-1.5 font-medium leading-relaxed">Escrito por pessoas reais, sem agendas comerciais.</p>
                </div>
              </div>
            </div>
