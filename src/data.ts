...
export const testimonialsData: Testimonial[] = [
  {
    ...
    text: "“Comecei aplicando apenas algumas dicas e já consegui melhorar minha alimentação e minha disposição! Minha família toda está comendo melhor e sem ver a fatura do mercado explodir.”",
    rating: 5,
  ...
  {
    id: "jorge",
    name: "Seu Jorge Mendes",
    role: "Aposentado, 62 anos",
    text: "“Gostei porque é simples, prático e cabe no meu orçamento. O plano de 30 dias mudou o jeito como vejo as compras de feira. Hoje cozinho com prazer e sinto as minhas dores nas articulações sumirem.”",
    rating: 5,
  ...
  },
  {
    ...
    text: "“Finalmente encontrei algo fácil de entender e que funciona na vida real. Não tem aquelas coisas caras que a gente nunca acha no mercado comum. É comida acessível feita por quem entende a nossa luta diária.”",
    rating: 5,
